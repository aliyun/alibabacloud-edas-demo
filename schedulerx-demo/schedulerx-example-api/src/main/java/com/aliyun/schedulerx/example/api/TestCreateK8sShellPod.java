 ...
 * @author xiaomeng.hxm
 */
public class TestCreateK8sShellPod {
	
	private static String shell_script = "echo 'hello world'";
    ...
    public static void main(String[] args) throws Exception {
        ...
        request.setContent(shell_script);
        K8sJobXAttrs xAttrs = new K8sJobXAttrs();
		xAttrs.setResource("shell");
		xAttrs.setImage("busybox");
